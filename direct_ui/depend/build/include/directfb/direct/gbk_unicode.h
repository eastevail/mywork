/******************************************************************************
	...
	File Name		: gbk_unicode.h
	Version		: 1.0
	Author		: JABSCO Video Server Software Group
	Created		: 2010.05.11
	Description	: buffer interface
	History		:
				Create by fzy 2010.05.11
	download from: http://blog.chinaunix.net/u/21842/showart_152007.html
******************************************************************************/
#ifndef GBK_UNICODE_H
#define GBK_UNICODE_H

#include <stdio.h>
#include <wchar.h>

typedef struct { unsigned short map[256]; } convert_table_t;
typedef struct { const convert_table_t *index[256]; } convert_table_index_t;
...
int GBKToUnicode(wchar_t *to, char *from, int bytes);

int UnicodeToGBK(char *to, wchar_t *from, int words);
