...
typedef void (*AfterDrawLabel) (void *ctx);
...
DFBResult lite_set_label_set_visible(LiteLabel *label, bool visible);

DFBResult lite_set_label_bgcolor(LiteLabel *label, DFBColor *color);

DFBResult lite_set_label_draw_after(LiteLabel *label, AfterDrawLabel callback, void *ctx);
