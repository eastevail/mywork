 ...
 *
 * JPEG encode function header file
 *
...
/* copy from BSP/linux/include/asm-arm/arch-w55fa95/jpegcodec.h */
...
int jpegCodec_reserved(uint8_t *pu8PicPtr);
int jpegCodec_reserved_QVGA(uint8_t *pu8PicPtr);
...
//int jpegEncFB(__u16 * pVideoBuffer);
int jpegEncFB(
char * pVideoBuffer,
int s_i32FBWidth,
int s_i32FBHeight
...
typedef struct
{
	E_JPEG_ENC_THB_SUPP eJpegEncThbSupp;
	BOOL bUpScale;
}S_JPEG_ENC_FEAT;
