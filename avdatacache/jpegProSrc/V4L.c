...
int saveV4LBuffer_QVGA(char *buf)
{
	int32_t	val;
	unsigned char *pVideoBuf;
#ifdef __DUMP_PACKET__
...
#ifdef __DUMP_PACKET__
//	val = write(file, pVideoBuf, (320*240*2));
	memcpy(buf,pVideoBuf,(320*240*2));
		printf("cpdumpV4LBuffer.320*240 \n");
#else
//	val = write(file, pVideoBuf, (640*480*2));
	//memcpy(buf,pVideoBuf,(640*480*2));
	memcpy(buf,pVideoBuf,(320*240*2));
	//printf("cpdumpV4LBuffer.640*480 \n");
#endif
